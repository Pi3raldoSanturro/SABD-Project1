...
echo "You can go to /MongoDB folder, open a new terminal and run ./spark_mongo_insert.sh script manually for ingest the result in MongoDB with Apache Spark"
